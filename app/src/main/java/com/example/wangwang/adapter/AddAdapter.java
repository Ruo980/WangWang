...
public class AddAdapter extends BaseAdapter {
    ...
    public AddAdapter(Context context, List<HashMap> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.add_type_item, viewGroup, false);
            viewHolder = new ViewHolder();
            viewHolder.imageView = view.findViewById(R.id.add_money_type_image);
            viewHolder.mTextView = view.findViewById(R.id.add_money_type_text);
